...
private:
  ...
  Handle< GenParticleCollection > CandHandleParton  ;
  ...
  int    gen_number_photon;
  int    gen_number_parton;
  int    gen_n_photon_pt75;
  int    gen_n_jet_pt20;
  int    gen_n_jet_pt75;
  ...
  int    genMomId;
  double genIsoDR04;
  int    interaction_tag_leadingPhoton; //1->HI, 2->MPI, 0->no match,or other source
  double gen_pT_leadingPhoton;
  double gen_eta_leadingPhoton;
  double gen_phi_leadingPhoton;
  //jet info
  int    interaction_tag_leading1stJet; //1->HI, 2->MPI, 0->no match,or other source
  double gen_pT_leading1stJet;
  double gen_eta_leading1stJet;
  double gen_phi_leading1stJet;
  int    interaction_tag_leading2ndJet; //1->HI, 2->MPI, 0->no match,or other source
  double gen_pT_leading2ndJet;
  double gen_eta_leading2ndJet;
  double gen_phi_leading2ndJet;
  int    interaction_tag_leading3rdJet; //1->HI, 2->MPI, 0->no match,or other source
  ...
  TTree* GEN_Photon_AnalysisTree;

  vector<double> b_genphotonPt;
  vector<double> b_genphotonEta;
  vector<double> b_genphotonPhi;
  vector<double> b_genphotonIso;
  vector<int> b_genphotonMom;
  vector<int> b_genphotonTag;
  int GenPhoton_DPS;  
