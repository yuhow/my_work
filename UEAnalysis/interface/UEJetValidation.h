...
private:
  ...
  virtual void fillHistogramsChgGenAll(BasicJet &theLeadingTrackJet,
				     GenJet   &theLeadingChgGenJet );

  virtual void fillHistogramsCaloAll(BasicJet &theLeadingTrackJet,
				   CaloJet  &theLeadingCaloJet );
  virtual void  fillHistogramsPartonAll(reco::GenParticle, reco::GenParticle, reco::BasicJet&);
  ...
  ///
  double DeltaR_pvsrecojet;
  double DeltaPhi_pvsrecojet;
  double DeltaEta_pvsrecojet;
  double pt_p;
  double p_p;
  double eta_p;
  double phi_p;
 
  double DeltaR_recojetvsgenjet;
  double DeltaPhi_recojetvsgenjet;
  double DeltaEta_recojetvsgenjet;
  double pt_recojet;
  double p_recojet;
  double eta_recojet;
  double phi_recojet;
  ...
  TH1D** h_dR_tracksjet_genparton;
  TH1D** h_pT_genparton;
  TH1D** h_eta_genparton;
  TH1D** h_phi_genparton;
  TH1D** h_pTratio_tracksjet_genparton;

  TH1D** h_eta_genpartonMatched;
  TH1D** h_pT_genpartonMatched;
  TH1D** h_phi_genpartonMatched;
  TH2D** h2d_pTratio_trackjet_genparton;
  TH2D** h2d_dR_tracksjet_genparton;
  TH2D** h2d_dphi_tracksjet_genparton;
