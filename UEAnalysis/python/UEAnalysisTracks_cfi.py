...
#    ptMin = cms.double(0.100),
#    maxRapidity = cms.double(2.5),
#    vtxntk = cms.double(0),                  #selection evets with vertex recostructed with at least 3 tracks non attivo
#    ndof= cms.double(4),
...
UEAnalysisTracks = cms.Sequence(goodTracks)
