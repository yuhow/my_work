...
public :
  ...
  virtual void     MultiAnalysis(char* filelist,char* outname,vector<float> weight,Float_t eta,string type,string trigger,string tkpt,Float_t ptCut,Int_t run);
  ...
  virtual void     Loop(Float_t we,Float_t triggerPt,string type,string trigger,string tkpt,Int_t run);
