...
process = cms.Process("DPSAnalysisValFile")
...
process.p1 = cms.Sequence((process.UEAnalysisTracks
                      ...
                      *process.UEAnalysisPFJets
                      ...
                      +process.DPSAnalysisValidation))

process.goodvertex=cms.Path((process.primaryVertexFilter+process.noscraping)*process.L1L2L3CorJetAK5PF*process.p1)

process.DPSAnalysisRootpleVal.OnlyRECO     = False 
process.DPSAnalysisRootpleVal.IsMC = True
process.DPSAnalysisRootpleVal.IsDATA = False
process.DPSAnalysisRootpleVal.Have_PILEUP = True

process.DPSAnalysisRootpleVal.PFJetCollectionName       = 'L1L2L3CorJetAK5PF'
